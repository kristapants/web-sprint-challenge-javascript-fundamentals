...
*/
const displayNames = zooAnimals.map(zooAnimals => `Name: ${zooAnimals.animal_name}, Scientific: ${zooAnimals.scientific_name}.`);
...
let populationTotal = zooAnimals.reduce((accum, item) => accum + item.population,0);
